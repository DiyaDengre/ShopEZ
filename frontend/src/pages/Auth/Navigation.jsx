...
import { FaHeart, FaUserCircle, FaTachometerAlt } from "react-icons/fa"; // ✅ added FaTachometerAlt
          ...
          {userInfo ? (
            <div className="flex flex-col gap-4">
              ...
              {userInfo.isAdmin && (
                <Link
                  to="/admin/dashboard"
                  className="flex items-center hover:translate-x-2 transition text-pink-400"
                >
                  <FaTachometerAlt className="mr-2" size={22} />
